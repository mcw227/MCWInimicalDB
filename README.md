...
&emsp; The only other "substantial" use of AI was for the implementation of a compound trigger, and the story behind that may be found in the table_maker.sql file.
...
1. Is there a standard regex expression to verify emails?
