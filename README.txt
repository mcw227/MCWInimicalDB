...
***IMPORTANT***
In order to test the two manager interfaces, log in with id = 1 for location manager and id = 2 for sales manager. The rest of the employees are randomly defined.
